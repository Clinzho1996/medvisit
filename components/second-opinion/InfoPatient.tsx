...
const leftColumnItems: CheckItem[] = [
	{
		id: 1,
		text: "Get a second opinion if you have undergone treatment but your symptoms continue",
	},
	{
		id: 2,
		text: "Get a second opinion if you are diagnosed with a rare disease",
	},
	{ id: 3, text: "Get a second opinion if you are diagnosed with cancer." },
	{ id: 4, text: "Your diagnosis isn't clear." },
	{ id: 5, text: "You have a lot of medical conditions." },
	{
		id: 6,
		text: "The treatment offered is experimental, controversial, or risky.",
	},
];
...
const rightColumnItems: CheckItem[] = [
	{
		id: 7,
		text: "After consulting with your doctor, you still have a number of unanswered questions",
	},
	{ id: 8, text: "You have a life-threatening condition." },
	{ id: 9, text: "You feel like you can't talk to your current doctor." },
	{ id: 10, text: "Your doctor says they can't help you or won't treat you." },
	{ id: 11, text: "Your doctor is not a specialist in your condition." },
	{ id: 12, text: "Numerous possible treatment options are available" },
];
			...
			<div className="mx-auto px-6 md:px-20 bg-[#051429] md:pt-20 md:pb-56 pt-16 pb-48">
				...
				<div className="mx-auto max-w-3xl text-center">
					...
					<p className="mt-4 text-xs leading-relaxed text-gray-400 sm:text-sm">
						Sometimes your health problems are straightforward, but there are
						other times when diagnosis and treatment are less clear. Getting a
						second opinion may be helpful when:
					</p>
				</div>
