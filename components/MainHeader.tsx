...
const Navbar = () => {
	...
	const navLinks = [
		...
		{ name: "Second Medical Opinion", href: "#" },
		{ name: "Global Mobility", href: "#" },
	...
	return (
		<header className="w-full font-sans border-b border-gray-100 shadow-2xl shadow-[#05213A]/10  sticky top-0 z-50 bg-white">
			...
			<div className="bg-[#FAFAFA] border-b border-gray-200 py-2 hidden lg:block">
				<div className="max-w-7xl mx-auto px-6 flex justify-between items-center text-[11px] text-gray-600">
