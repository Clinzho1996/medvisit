...
const OverviewAndProblemSection = () => {
	const highlights = [
		"No $200,000 investment.",
		"No language test.",
		"No complicated applications.",
		"Your child receives Chilean citizenship automatically by birth",
		"A passport that opens doors to 175+ countries including the USA, UK, and EU.",
	];
				...
				<div className="flex flex-col lg:flex-row gap-12 items-start mb-16">
					<div className="lg:w-1/2">
						...
						<h2 className="text-2xl md:text-3xl font-bold text-[#0F2331] tracking-tighter leading-tight mb-6 pr-0 sm:pr-20">
							...
							family's horizons in an unpredictable world. Strategic solutions
							to protect your wealth and expand your family's horizons in an
							unpredictable world.
						</h2>
					</div>
...
export default OverviewAndProblemSection;
