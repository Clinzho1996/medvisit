				...
				<motion.div
					...
					<div className="relative z-10 max-w-4xl">
						<h2 className="text-2xl md:text-4xl font-semibold leading-tight tracking-tighter mb-4">
							Start Your Chilean Residency Journey
						</h2>

						<p className="text-[#F9F9F9] text-sm tracking-tight mb-4">
							Book a free consultation to determine which track is right for
							your family.
						</p>
...
export default ResMobilityFooter;
