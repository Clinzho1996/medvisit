				...
				<motion.div
					...
					<div className="relative z-10 max-w-4xl">
						<h2 className="text-2xl md:text-4xl font-semibold leading-tight tracking-tighter mb-4">
							Start Your Child&apos;s Journey to Global Freedom
						</h2>

						<p className="text-[#F9F9F9] text-sm tracking-tight mb-4">
							Book your free consultation today. We&apos;ll walk you through the
							process, answer your questions, and provide a personalized cost
							estimate.
						</p>
...
export default CbiMobilityFooter;
